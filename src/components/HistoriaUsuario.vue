    ...
    <div class="modal" ref="modal">
        ...
        <div class="modal-content">
            ...
            <div class="modalDesc">
                ...
                <p>
                    El sistema debe contar con la capacidad de generar graficas.
                </p>
                ...
                <div v-if="tab === 'funcionalidad'">
                    <div class="modalTab">
                        ...
                        <p>
                           Deben generarse de manera automatica, segun la informacion disponible para el usuario.
                        </p>
                    </div>
                </div>
                ...
                <div v-else>
                    <div class="modalTab">
                        <span>Rol:</span>
                        <p>
                            Se toma el valor tx_rol de la tabla i007t_historia_usuario dentro de la base de datos del sistema
                        </p>
                    </div>
                </div>
