<template>
    <div class="table-container">
        <table class="highlight fixedTable">
            ...
            <tbody>
                <tr class="tableBody">
                    <td>Definición de los requerimientos del sistema</td>
                    <td>Completada</td>
                    <td>100%</td>
                    <td class="actionButtons">
                        <a class="btn-floating" @click="openModal"><i class="material-icons">more_vert</i></a>
                    </td>
                </tr>
                <tr class="tableBody">
                    <td>Desarrollar modal de eliminación</td>
                    <td>Por comenzar</td>
                    <td>0%</td>
                    <td class="actionButtons">
                        <a class="btn-floating" @click="openModal"><i class="material-icons">more_vert</i></a>
                ...
                <tr class="tableBody">
                    <td>Desarrollar modal de tareas</td>
                    <td>En desarrollo</td>
                    <td>40%</td>
                    <td class="actionButtons">
                        <a class="btn-floating" @click="openModal"><i class="material-icons">more_vert</i></a>
        ...
        <div class="modal-footer">
            <div class="footerContent">
                ...
                <div class="col l3 input-field dataField">
                    <input type="number" placeholder="" id="cumplimiento_actual" min="0" max="100" step="10" @input="validateInput" class="center">
