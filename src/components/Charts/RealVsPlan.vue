<template>
    <div class="chartCard">
        <span class="white-text">
            <i class="material-icons">stacked_line_chart</i>Grafica Real Vs. Planificado
        </span>
    ...
    methods: {
        renderChart() {
            ...
            this.chart = Highcharts.chart(chartContainer, {
                ...
                series: [{
                    name: 'Real',
                    data: [16.0, 18.2, 23.1, 27.9, 32.2, 36.4, 39.8, 38.4, 35.5, 29.2, 22.0, 100],
                    color: '#00bcd4',
                    lineWidth: 5,
                    marker: {
                        symbol: "square",
                    ...
                    name: 'Planificado',
                    data: [2.9, 25.2, 0.6, 4.8, 10.2, 14.5, 17.6, 16.5, 12.0, 6.5, 2.0, 0.9],
                    color: '#e53935',
                    lineWidth: 5,
                    marker: {
                        symbol: "square",
